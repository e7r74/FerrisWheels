  ...
  return (
    <div className="min-h-screen bg-stone-900 text-stone-100 p-6 flex flex-col items-center">
      ...
      <div className="relative">
        ...
        <div
          className="w-80 h-80 rounded-full border-[12px] border-stone-800 relative overflow-hidden transition-transform duration-[3s] ease-[cubic-bezier(0.2,0.8,0.2,1)]"
          style={{
